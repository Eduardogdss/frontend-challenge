...
const Artist = () =>{
    ...
    async function fetchArtist(){
        setLoading(true);
        await somosClient.getFullArtist(id)
            .then(data =>{
                const [Artista,{items:albumsList,error:albumError}] = data;
                if (!Artista.error || !albumError){
                    console.log('artista',Artista.name);
                    setArtista(Artista);
                    setAlbums(albumsList);
                    setGenders(Artista.genres);

                }else{
                    setArtista({name:'Não Encontrado', images:[],popularity:0});
                    setAlbums([]);
                }
                setLoading(null);
            },
            ...
            <Layout>
                ...
                <div className={styles.box}>
                    ...
                    <>
                        ...
                        <div className={styles.ratings}>
                            ...
                            <div className={styles.fullStars} style={{width:`${artista.popularity + '%'}`}}></div>
                        </div>
                    </>
                    }
                ...
                <div className={styles.albumContainer}>
                    ...
                    <div className={styles.album}>
                        ...
                        <img className={styles.albumImage}src={album.images ? album.images[0].url : ''} alt={album.name} />
